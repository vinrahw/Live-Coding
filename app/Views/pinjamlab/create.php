    ...
    <div class="row">
        ...
        <div class="row mb-3">
            ...
            <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker" inline="true">
                <input placeholder="Select date" type="date" id="tanggal_peminjamam" class="form-control" name="tanggal_peminjamam" value="<?= old('tanggal_peminjamam'); ?>">
        ...
        <div class="row mb-3">
            ...
            <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker" inline="true">
                <input placeholder="Select date" type="date" id="waktu_peminjaman" class="form-control">
        ...
        <div class="row mb-3">
            <label for="foto" class="col-sm-2 col-form-label">Barang yang Dipinjam</label>
            <div class="col-sm-10">
